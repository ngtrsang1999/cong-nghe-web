...
?>	
	<span title="Thêm thể loại" style=" position: fixed; z-index: 100; border-radius: 50%; width: 100px; height: 100px; cursor: pointer; bottom: 70px; left: 30px;" class="bg-success p-4 text-center" data-toggle="modal" data-target="#modal-quanlyuser" onclick=""><i class="fa fa-plus" aria-hidden="true" style="line-height: 50px;font-size: 40px;"></i></span>
		<!-- modal -->
								...
								<?php
									...
									foreach ($listCategories as $key => $value) {
								    	...
								    	<tr>
								    		...
								    		<td>
								    		<i title="Edit" class="fa fa-pencil-square-o mr-2" aria-hidden="true"></i>
