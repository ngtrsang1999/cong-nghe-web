                ...
                <div>
                    ...
                    <div class="tab-content">
                        <div class="form-login ">
                            ...
                            <input type="email"  placeholder="Tài khoản" id="email_login" class="ip-just-a-zA-Z0-9_">
                            <input type="password" placeholder="Mật khẩu" id="password_login" class="ip-just-a-zA-Z0-9_">
                        ...
                        <div class="form-registration">
                            ...
                            <input type="email" placeholder="Tài khoản" id="email_register" class="ip-just-a-zA-Z0-9_">
                            <input type="password" placeholder="Mật khẩu" id="password_register" class="ip-just-a-zA-Z0-9_">
                            <input type="password" placeholder="Nhập lại mật khẩu" id="rp_password_register" class="ip-just-a-zA-Z0-9_">
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
                ...
                <div class="form-change-pw">
                            ...
                            <input type="password" class="reset-form ip-just-a-zA-Z0-9_" placeholder="Mật khẩu cũ" id="old_pw">
                            <input type="password" class="reset-form ip-just-a-zA-Z0-9_" placeholder="Mật khẩu mới" id="new_pw">
                            <input type="password" class="reset-form ip-just-a-zA-Z0-9_" placeholder="Nhập lại mật khẩu mơi" id="repeat_new_pw">
